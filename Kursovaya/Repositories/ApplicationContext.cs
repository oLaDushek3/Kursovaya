...
public partial class ApplicationContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer(@"Server=DESKTOP-ITT8EDC\SQLEXPRESS;Database=Kursovaya;Trusted_Connection=True;Encrypt=False");
